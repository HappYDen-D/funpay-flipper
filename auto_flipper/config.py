...
FUNPAY_MARKET_GET_MIN_INTERVAL_SECONDS = float(os.getenv("FUNPAY_MARKET_GET_MIN_INTERVAL_SECONDS", "2.0"))
FUNPAY_MARKET_GET_JITTER_SECONDS = float(os.getenv("FUNPAY_MARKET_GET_JITTER_SECONDS", "0.75"))
FUNPAY_MARKET_GET_429_BACKOFF_SECONDS = float(os.getenv("FUNPAY_MARKET_GET_429_BACKOFF_SECONDS", "60"))
...
ACCOUNT_SNAPSHOT_MIN_COVERAGE_RATIO = float(os.getenv("ACCOUNT_SNAPSHOT_MIN_COVERAGE_RATIO", "0.98"))
ACCOUNT_SNAPSHOT_MIN_PREVIOUS_RATIO = float(os.getenv("ACCOUNT_SNAPSHOT_MIN_PREVIOUS_RATIO", "0.60"))
ACCOUNT_FAILURE_BACKOFF_INITIAL_SECONDS = float(os.getenv("ACCOUNT_FAILURE_BACKOFF_INITIAL_SECONDS", "300"))
ACCOUNT_FAILURE_BACKOFF_MAX_SECONDS = float(os.getenv("ACCOUNT_FAILURE_BACKOFF_MAX_SECONDS", "1800"))
ACCOUNT_RISK_EVIDENCE_MEDIUM_RATIO = float(os.getenv("ACCOUNT_RISK_EVIDENCE_MEDIUM_RATIO", "0.35"))
ACCOUNT_RISK_EVIDENCE_HIGH_RATIO = float(os.getenv("ACCOUNT_RISK_EVIDENCE_HIGH_RATIO", "0.70"))
